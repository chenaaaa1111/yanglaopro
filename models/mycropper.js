...
function prepare () {
  ...
  self.attachPage = function () {
    ...
    //  把this依附在Page上下文的mycropper属性上，便于在page钩子函数中访问
    pageContext.mycropper = self;
  };
...
var mycropper = function mycropper (params) {
  var self = this;
  var _default = {};
...
mycropper.prototype.init = function init () {
  var self = this;
  var src = self.src;
...
Object.assign(mycropper.prototype, handle);

mycropper.prototype.prepare = prepare;
mycropper.prototype.observer = observer;
mycropper.prototype.methods = methods;
mycropper.prototype.cutt = cut;
mycropper.prototype.update = update;
